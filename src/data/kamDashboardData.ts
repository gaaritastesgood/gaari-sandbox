...
export const attentionItems: AttentionItem[] = [
  {
    id: "att-001",
    customerId: "1",
    customerName: "Pacific Steel Manufacturing",
    accountId: "ACC-78234",
    industry: "Industrial",
    annualRevenue: "$2.4M",
    reason: "Extended outage impacting production line - 6.2 hour interruption",
    category: "outage",
    severity: "critical",
    confidence: 96,
    evidencePoints: [
  ...
  },
  {
    id: "att-002",
    customerId: "2",
    customerName: "Metro Distribution Center",
    accountId: "ACC-91456",
    industry: "Large Commercial",
    annualRevenue: "$1.8M",
    reason: "Multiple outage events affecting cold storage operations",
    category: "outage",
    severity: "critical",
    confidence: 94,
    evidencePoints: [
      "3 outage events in past 14 days",
      "Cold storage temperature variance recorded",
      "Perishable goods at risk - $450K inventory",
      "Requesting reliability improvement plan",
    ],
    detectedAt: "4 hours ago",
    quickFacts: [
      { label: "Outages (14d)", value: "3 events" },
      { label: "Monthly Bill", value: "$156K" },
      { label: "At-Risk Inventory", value: "$450K" },
    ],
  },
];
