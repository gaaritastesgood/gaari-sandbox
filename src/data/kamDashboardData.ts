...
export const attentionItems: AttentionItem[] = [
  ...
  },
  {
    ...
    industry: "Industrial",
    annualRevenue: "$8.7M",
    reason: "3 Outages In 14 Days - Production Line At Risk",
    category: "outage",
    severity: "critical",
    confidence: 94,
    evidencePoints: [
      "3 outage events in past 14 days across facility",
      "Backup generators activated during events",
      "Production line equipment requiring stable power",
  ...
  },
  {
    ...
    evidencePoints: [
      ...
      "New production equipment installations",
...
export const kpiDrilldownData: Record<string, KPIDrilldownData> = {
  ...
  outages: {
    ...
    items: [
      ...
      { id: "2", customerId: "12", customerName: "Keystone Manufacturing Group", metric: "3 events", detail: "Production at risk • Backup activated • Past 14 days", status: "error" },
  ...
  alerts: {
    ...
    items: [
      ...
      { id: "2", customerId: "12", customerName: "Keystone Manufacturing Group", metric: "Critical", detail: "3 outage events • Production line at risk", status: "error" },
      { id: "3", customerId: "12", customerName: "Keystone Manufacturing Group", metric: "High", detail: "Load growth +15% YTD • Capacity planning needed", status: "warning" },
  ...
  opportunities: {
    ...
    chartData: [],
    items: [
      { id: "1", customerId: "12", customerName: "Keystone Manufacturing Group", metric: "Facility Expansion Power Planning", detail: "+15% YTD growth • $1.4M potential revenue", status: "good" },
