...
export const attentionItems: AttentionItem[] = [
  {
    ...
    industry: "Industrial",
    annualRevenue: "$2.4M",
    reason: "Outage at Chestnut Street Location - 30 Minutes, $50K Loss",
    category: "outage",
    severity: "critical",
    confidence: 96,
    evidencePoints: [
      "Outage duration: 30 minutes at Chestnut Street location",
...
export const opportunityItems: OpportunityItem[] = [
  {
    ...
    opportunityName: "Refrigeration Efficiency Program",
    estimatedValue: "$85K annual savings potential",
    confidence: 87,
    evidence: [
      "Fleet of 40+ commercial refrigeration units across locations",
      "Current units averaging 12+ years old",
      "Eligible for commercial refrigeration rebates up to $15K per unit",
      "Estimated 18% reduction in refrigeration energy costs",
    ],
    status: "new",
  },
  {
...
export const kpiDrilldownData: Record<string, KPIDrilldownData> = {
  ...
  demand: {
    ...
    items: [
      { id: "1", customerId: "12", customerName: "Keystone Manufacturing Group", metric: "18.5 MW", detail: "Peak increasing +8% YoY", status: "warning" },
      { id: "2", customerId: "11", customerName: "Giant Food", metric: "4.2 MW", detail: "Peak during business hours", status: "good" },
  ...
  alerts: {
    ...
    items: [
      { id: "1", customerId: "11", customerName: "Giant Food", metric: "Critical", detail: "30min outage at Chestnut Street • $50K loss", status: "error" },
